...
Write-Verbose "O espaço consumido pelos arquivos a serem excluídos é de $([math]::Round($total/1MB,2))MB"
Log "O espaço consumido pelos arquivos a serem excluídos é de $([math]::Round($total/1MB,2))MB"
